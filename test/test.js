...
describe('Basic function invocations', function () {
    ...
    it('Correction cases', function () {
        expect(etc.checkEmailTypos("agnes@gxm.de")).to.eql(["agnes@gmx.de"]);
        ...
        expect(etc.checkEmailTypos("test@Googlmail.com")).to.eql(["test@googlemail.com", "test@gmail.com"]);
        expect(etc.checkEmailTypos("test@gmx")).to.eql(["test@gmx.de", "test@gmx.at", "test@gmx.net", "test@gmx.com", "test@gmail.com"]);
